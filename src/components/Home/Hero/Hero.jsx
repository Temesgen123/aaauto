...
import img from '../../../assets/images/heroImageBlue.webp';
    ...
    <div className="shadow-lg  heropage  h-screen relative  ">
      <div className="container flex flex-col md:flex-row justify-center items-center">
        ...
        <div className="w-full md:w-2/4 space-y-5 md:mt-24 mt-10 relative px-6">
          ...
          md:bg-gradient-to-r from-black to-[#000] bg-clip-text md:text-transparent backdrop-opacity-50  text-[#010c42]"
          >
          ...
          <h2 className=" text-xl lg:text-2xl font-bold text-[#010c42] md:text-black">
          ...
          <div className="flex gap-8 ">
            <Link to={'/aaauto/services'}>
              <button className="bg-[#1b0459] py-1 px-4 rounded-md font-bold border-2 text-black hover:scale-95 hover:bg-white hover:text-[#1b0459] hover:border-blue-900 transition duration-400 ease-linear mt-5">
                Explor More
              </button>
            </Link>
            <Link to={'/aaauto/cars'}>
