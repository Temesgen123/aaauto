...
const FeaturedCard = ({ id, image, name, price, }) => {
  return (
    ...
    >
      ...
      <div >
        <img src={image[0]} alt="carimage" className="rounded-t-xl max-w-[160px] sm:max-w-[240px] md:max-w-[300px]"  />
      </div>
      <div className="flex flex-col justify-center items-center">
        <h1 className="font-semibold  text-md md:text-lg pt-1 text-orange-600">{name}</h1>
